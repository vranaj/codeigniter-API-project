...
|
*/
$config['OCU_site_name'] = "Procurement System";
...
$config['OCU_message_template'] =<<<EOD
	<div class="notification {type}" >
		<div id="notification_text">{message}</div>
	</div>
...
| CACHE View
|--------------------------------------------------------------------
| Whether or not to cache the current view called by the yield_content() method.
|
*/
